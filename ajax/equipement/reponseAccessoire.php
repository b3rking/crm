  <?php
                            $i=0;
                            foreach ($equipement->afficheAccessoire() as $value) 
                                {
                                    $i++;
                                  ?>
                                    <tr>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="myLargeModalLabel">Modifier cet accessoire</h4>
                   ...
                   <div class="col-sm-9">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"></span></div> <input type="number" id="quantite<?= $i?>" value="<?php echo $value->quantite?>" class="form-control" >
                                </div>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <textarea rows="5"  class="form-control " id="commentaire<?= $i?>" placeholder="commentaire           ici..."><?php echo $value->commentaire?></textarea>
                        ...
                        <div class="modal-footer">
                          <button type="button" data-dismiss="modal" style="background-color: #8b4513"class="btn text-white" onclick="update_accessoire($('#idaccessoiree<?=$i?>').val(),$('#quantite<?=$i?>').val(),$('#commentaire<?=$i?>').val())"> <i class="fa fa-check"></i> Modifier accessoire</button>

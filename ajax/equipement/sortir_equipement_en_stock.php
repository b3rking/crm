...
<?php
	...
	//{
		...
		if ($equipement->sortier_equipement_en_stock($_GET['idequipement'],$_GET['motif'],$_GET['date_sortie'],$_GET['sortie_par'],$_GET['demander_par'],$_GET['destination'],$destination_detail))
		{
		    if ($equipement->updateEquipementUsed($_GET['idequipement'],$used = 'pending') > 0) 
			{

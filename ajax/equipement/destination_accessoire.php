    	...
    	<div class="row">
    		<div class="col-lg-12 col-md-12">
        		...
        		<div class="form-group">
                	<!--<input type="text" id="idclient_attribu_accessoir" name="idclient" class="form-control input-filter" autocomplete="off" onkeyup="getClientToAtrib_Accessoir(this.value)">

...
<div class="row">
    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
        	<a href="/crm.spidernet/ficheAugmentionBP" type="button" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Fiche bande passante</a>
            <a href="/crm.spidernet/ficheinstallation" type="button" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Fiche D'installation</a>

            <!-- sample modal content -->
            <div class="modal fade ficheinstallation" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myLargeModalLabel">Generation de fiche D'installation</h4>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-9">
                                    <input type="text" id="idclient2" class="form-control" autocomplete="off">
                                        <div id="modal"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                    	<div class="col-lg-12 col-md-12 form-group">
                            <div class="input-group">
                                ...
                                <textarea rows="5" maxlength="245"  class="form-control " id="description" placeholder="Description           ici..."></textarea>
                                <input type="text" id="idUser" value="<?= $_GET['idUser']?>" hidden>
                            </div>
                        </div>
                    </div>
                    </form>
                        ...
                        <div class="modal-footer">
                            <span id="msg"></span>
                            <button type="button" class="btn btn-info waves-effect text-left" onclick="genererFicheInstallation()">Generer Fiche
                                        </button>
            ...
            <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                        	<span id="msg"></span>
                            <button class="btn btn-success waves-effect text-left" onclick="saveContract($('#numero').val(),$('#typecontract').val(),$('#monnaie').val(),$('#mode').val(),$('#etat').val(),$('#idclient').val(),$('#service1').val(),$('#bandepassante1').val(),$('#rediction1').val(),$('#quantite1').val())"><i class="fa fa-check"></i>Enregistrer
     						</button>
            ...
            <div class="modal fade bs-example-modal-lg<?=$i?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
	                            		...
	                            		<div class="form-group row">
		                                    ...
		                                    <div class="col-sm-9">
		                                        <div class="input-group">
		                                            ...
		                                            <input type="text" class="form-control" id="numero<?=$i?>">
		                                        </div>
		                                    </div>
		                                </div>
	                            	</div>
	                                <div class="col-lg-6 col-md-6">
	                            		<div class="form-group row">
		                                    ...
		                                    <div class="col-sm-9">
		                                        <div class="input-group">
		                                            <div class="input-group-prepend"><span class="input-group-text"><i class="ti-user"></i></span></div>
		                                            <select id="typecontract<?=$i?>" class="form-control">
		                                            	<option value=""></option>
		                                            	<option value="service">service</option>
		                                            	<option value="equipement">equipement</option>
		                                            </select>
	                            	...
	                            	<div class="col-lg-6 col-md-6">
	                            		<div class="form-group row">
		                                    ...
		                                    <div class="col-sm-9">
		                                        <div class="input-group">
		                                            <div class="input-group-prepend"><span class="input-group-text"><i class="ti-user"></i></span></div>
		                                            <input type="text" id="client<?=$i?>" class="form-control">
		                                        </div>
		                                    </div>
		                                </div>
	                            	</div>
	                            	...
	                            	<div class="col-lg-6 col-md-6">
	                            		<div class="form-group row">
		                                    ...
		                                    <div class="col-sm-9">
		                                        <div class="input-group">
		                                            <div class="input-group-prepend"><span class="input-group-text"><i class="ti-user"></i></span></div>
		                                           <select id="service<?=$i?>" class="form-control">
		                                           	<?php
		                                           	foreach ($service->recupererServices() as $value) :?>
		                                           		<option value="<?= $value->ID_service?>"><?= $value->nomService?></option>
		                                           	<?php
	                            	...
	                            	<div class="col-lg-6 col-md-6">
	                            		<div class="form-group row">
		                                    ...
		                                    <div class="col-sm-9">
		                                        <div class="input-group">
		                                            <div class="input-group-prepend"><span class="input-group-text"><i class="ti-user"></i></span></div>
		                                            <input type="text" id="bandepassante<?=$i?>" class="form-control">
		                                        </div>
		                                    </div>
		                                </div>
	                            	</div>
	                            	...
	                            	<div class="col-lg-6 col-md-6">
	                            		<div class="form-group row">
		                                    ...
		                                    <div class="col-sm-9">
		                                        <div class="input-group">
		                                            <div class="input-group-prepend"><span class="input-group-text"><i class="ti-user"></i></span></div>
		                                            <input type="text" class="form-control" id="rediction<?=$i?>" data-mask="99">
		                                            <span class="font-13 text-muted">e.g "99%"</span>
		                                        </div>
		                                    </div>
		                                </div>
	                            	...
	                            	<div class="col-lg-6 col-md-6">
	                            		<div class="form-group row">
		                                    ...
		                                    <div class="col-sm-9">
		                                        <div class="input-group">
		                                            <div class="input-group-prepend"><span class="input-group-text"><i class="ti-user"></i></span></div>
		                                            <input type="text" class="form-control" id="quantite<?=$i?>">
		                                        </div>
		                                    </div>
		                                </div>
	                            	</div>
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-success  waves-effect" onclick="saveContract($('#numero<?=$i?>').val(),$('#typecontract<?=$i?>').val(),$('#monnaie<?=$i?>').val(),$('#mode<?=$i?>').val(),$('#etat<?=$i?>').val(),$('#client<?=$i?>').val(),$('#service<?=$i?>').val(),$('#bandepassante<?=$i?>').val(),$('#rediction<?=$i?>').val(),$('#quantite<?=$i?>').val())" data-dismiss="modal"><i class="fa fa-check"></i>Enregistrer
     						</button>
                            <button type="button" class="btn btn-danger waves-effect text-left" data-dismiss="modal"><i class="mdi mdi-close-circle-outline"></i>Fermer</button>
                        </div>
                    </div>
...
<div class="modal fade bs-example-modal-sm<?=$i?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body"> 
            	<input type="text" class="form-control" id="idcontract<?= $i?>" value="<?php echo $value->Nom_client;?>" hidden>
            	Voulez-vous supprimer ce contract?
            </div>
            <div class="modal-footer">
            	<button type="button" class="btn waves-effect waves-light btn-rounded btn-danger" onclick="deleteContract($('#idcontract<?= $i?>').val())" data-dismiss="modal">Supprimer</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>

...
<div id="element<?=$n?>">
    <div class="row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div class="input-group">
                        <input type="number" class="form-control form-control-sm" id="montantt<?=$n?>">
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-2 col-md-3">
            ...
            <div class="form-group col-sm-9"><input type="number" class="form-control form-control-sm" id="quantite<?=$n?>" value="1"></div>
        </div>
    </div><!-- End row -->
    <div class="row">
        <div class="col-lg-4 col-md-4">
        ...
        <div class="col-lg-2 col-md-2" id="divReduction0">
            ...
            <div class="form-group col-sm-9">
                <input type="number" class="form-control form-control-sm" id="rediction<?=$n?>" min="0">
            </div>
        </div>
    </div><!--End row -->

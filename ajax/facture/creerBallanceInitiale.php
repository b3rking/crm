...
$res = $contract->creerBallanceInitiale($_GET['idclient'],$_GET['date_creation'],$_GET['montant'],$_GET['monnaie'],$_GET['description']);
if ($res[1] == 1062) 
{
...
//	}
	...
	$id = $contract->getMaxIdBalanceInitiale()->fetch()['id'];
	if ($historique->setHistoriqueAction($id,'balanceInitiale',$_GET['iduser'],date('Y-m-d'),'creer')) 
	{

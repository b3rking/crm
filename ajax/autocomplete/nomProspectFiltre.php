<?php
	...
	if (!empty($result)) 
	{
		...
		{
			?>
		    <div class="item" idclient="<?php echo $value->nom ?>"><?php echo 'ID-'.$value->ID_prospect.'  '.$value->nom; ?>
		    </div>
			<?php
		}
	}
?>
<script src="assets/javascript/autocomplate/nomProspectFiltre.js"></script>
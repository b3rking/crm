<?php
	...
	if (!empty($result)) 
	{
		foreach ($client->autocompleteClientOnCreerPayement($result) as $value)
		{
			?>
...
?>
<script src="assets/javascript/autocomplate/itemSelectedAutocompleteClientCreePaiement.js"></script>
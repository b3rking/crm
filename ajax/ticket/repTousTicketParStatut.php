...
$i =0;
foreach ($ticket->recupereTousTicketParStatut($_GET['statut']) as $value) 
{
    $i++;
    ?>
    <tr>
        ...
        <td><?php echo $value->nom_user?></td>
         <td><?php if($value->status == 'ouvert')
            {
                ?>
                <span style="background-color: #ef7f22" class="label "><?php echo $value->status?></span>
                <?php
            } 
        ...
        <td class="text-nowrap">
                                    ...
                                    <a href="<?= WEBROOT;?>detailTicket-<?= $value->id;?>" data-toggle="tooltip" data-original-title="Voir"> <i class="fa fa-eye text-inverse m-r-10"></i>
                                    </a>

                                    <a href="" data-toggle="modal" data-target=".bs-example-modal-md<?=$i?>" data-original-title="Editer"> <i class="fa fa-pencil text-inverse m-r-10"></i></a>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-9">
                                    ...
                                    <select class="form-control" id="idclientCreerTicket<?=$i?>">

...
$i =0;
//filtreTicket()
    foreach ($ticket->afficheToustickets() as $value) 
    {
        $i++;
        ?>
           <tr>
                        <td><a href="/crm.buja/detailTicket-<?= $value->id?>"><?php echo 'Ticket#'.$value->id;?><a/>
                        </td>
                        <td><a href="/crm.buja/detailClient-<?= $value->ID_client;?>"><?php echo $value->Nom_client;?><a/>
                        </td>
                        ...
                        <td><?php echo $value->nom_user?></td>
                         <td><?php if($value->status == 'ouvert')
                                ...
                                <td class="text-nowrap">
                                    ...
                                    <a href="/crm.buja/detailTicket-<?php echo $value->id?>" data-toggle="tooltip" data-original-title="Voir"> <i class="fa fa-eye text-inverse m-r-10"></i>
                                    </a>

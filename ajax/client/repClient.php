...
<?php 
    ...
    <div class="col-lg-6 col-md-6">
        <div class="form-group row">
            <label for="exampleInputuname3" class="col-sm-4 control-label">Nom complet *</label>
            <div class="col-sm-9">
        ...
        <div class="form-group row">
            <label for="exampleInputuname3" class="col-sm-4 control-label">Pers contact</label>
            <div class="col-sm-9">
                <div class="input-group">
    ...
    <div class="col-lg-3 col-md-3">
<div class="form-group row">
    <label for="exampleInputuname3" class="col-sm-4 control-label">Telephone</label>
    ...
    <div class="col-lg-6 col-md-6">
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                ...
                <select class="form-control" id="type<?=$i?>"hidden>
                    <?php foreach ($type->recupererTypes() as $value2)
                    {
                        if ($value2->type_client == $value2->libelle) 
                        {
                        ?>
                    ...
                    <select class="form-control" id="newtype<?=$i?>">
                            ...
                            <?php foreach ($type->recupererTypes() as $val)
                    {
                        if ($val->type_client == $val->libelle) 
                        {
                        ?>
                            <option value="<?=$val->libelle?>" selected><?=$val->equivalent?></option>
                        <?php
                        }
                        else
                        {
                        ?>
                            <option value="<?=$val->libelle?>"><?=$val->equivalent?></option>
                        <?php
                        }
                    }
                    ?>
           ...
           <div class="col-sm-12 col-md-12 col-lg-12 col-xlg-12">
                <div class="form-group row">
                    ...
                    <div class="input-group">
                       ...
                       <input class="form-control" id="compteur<?=$i?>" value="<?=$i?>"hidden> 
                     </div>
                    </div>
                   </div>
                </div>
            ...
            <div class="modal-footer">
                <button class="btn text-white" style="background-color: #8b4513" onclick="updateClient($('#idclient<?=$i?>').val(),$('#nom<?=$i?>').val(),$('#pers_cont<?=$i?>').val(),$('#phone<?=$i?>').val(),$('#mail<?=$i?>').val(),$('#langue<?=$i?>').val(),$('#billing<?=$i?>').val(),$('#adrs<?=$i?>').val(),$('#type<?=$i?>').val(),$('#newtype<?=$i?>').val(),$('#location<?=$i?>').val(),$('#nif<?=$i?>').val(),$('#compteur<?=$i?>').val(),$('#note<?=$i?>').val())" data-dismiss="modal">Modifier
</button>

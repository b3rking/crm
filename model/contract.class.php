...
class Contract
{
	...
	*/
    ...
    function setFactureExemptOtt($facture_id, $exempt)
    {
        $con = connection();
        $query = $con->prepare("UPDATE facture SET exempt_ott = :exempt WHERE facture_id = :facture_id");
        $res = $query->execute(['exempt' => $exempt, 'facture_id' => $facture_id]);
        return $res;
    }

    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-warning">
                <h4 class="m-b-0 text-white">NOUVEAU EQUIPEMENT</h4>
            </div>
            <div class="card-body">
                <div id="rep"></div>
                <form>
<table width="100%" >
        ...
        <td width="50%"> 
            <div class="col-md-12">
                ...
                <select class="form-control custom-select" id="type_equipement" onchange="getTypeEquipement($('#type_equipement').val())">
                    ...
                    <option value="routeur-Dlink">routeur D-link</option>
    ...
    <tr><td></td>
        <td>
            <button type="button" style="background-color: #8b4513" class="btn text-white" onclick="ajouterStock($('#id').val(),$('#model').val(),$('#fabriquant').val(),$('#type_equipement').val(),$('#mac').val(),$('#number').val(),$('#numeroSerie').val(),$('#user').val())"> <i class="fa fa-check"></i> Ajouter</button>
        </td>
    </tr>
    </tbody>
</table>

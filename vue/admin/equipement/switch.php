...
$m = false;
$s = false;
if ($d = $user->verifierPermissionDunePage('switch',$_SESSION['ID_user'])->fetch()) 
{
    if ($d['L'] == 1) 
    {
        $l = true;
            ...
            <div class="card-body" >
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Switch</h4>
                    </div>
    <div class="col-md-7 align-self-center">
        <div class="d-flex justify-content-end align-items-center">
            ...
            {?>
                ...
                <button type="button" class="btn btn-chocolate d-none d-lg-block m-l-15 text-white" data-toggle="modal" data-target=".bs-example-modal-lgs"><i class="fa fa-plus-circle" class="modal fade" tabindex="-1" role="dialog"></i> Nouveau switch</button>
            <?php
            }
            ?>
    ...
    <div class="modal-dialog modal-lgs">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal p-t-0">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="text" id="type_equipement" value="switch" hidden="hidden">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="text" id="number" value="1" hidden="hidden">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group row">
                                <label for="exampleInputuname3" class="col-sm-3 control-label">Nombre de port</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" placeholder="example : 5" id="port">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-chocolate text-white" data-dismiss="modal" onclick="ajouterStock($('#marque').val(),$('#model').val(),$('#fabriquant').val(),$('#type_equipement').val(),$('#mac').val(),$('#user').val(),$('#date_ajout').val(),$('#description').val())"> <i class="fa fa-check"></i> Ajouter routeur</button>
...
<div class="modal fade bs-example-modal-lgs<?=$i?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lgs">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" style="background-color: #7c4a2f" class="btn text-white" data-dismiss="modal" onclick="updateswitch($('#id<?=$i?>').val(),$('#type_equipement<?=$i?>').val(),$('#model<?=$i?>').val(),$('#fabriquant<?=$i?>').val(),$('#date_stock<?=$i?>').val())"> <i class="fa fa-check"></i>
                 Modifier switch
                </button>

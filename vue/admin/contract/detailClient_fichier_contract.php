        ...
        <div class="card">
            ...
            <div class="tab-content">
                <div class="tab-pane active show" id="detailClient" role="tabpanel">
                    <div class="p-20">
<?php
    if ($value = $client->afficherUnClientAvecfichier_contrat($id)->fetch()) 
    {
?>
    <div class="row">
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <button type="button" class="btn btn-primary d-none d-lg-block m-l-15" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-plus-circle" class="modal fade" tabindex="-1" role="dialog"></i>attribuer materiel  </button>
                    <!-- Modal -->

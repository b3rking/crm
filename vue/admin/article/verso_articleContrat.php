                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-8 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                           ...
                           <button type="button" style="background-color: #8b4513" class="btn text-white d-none d-lg-block m-l-15" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-plus-circle"></i> Autre article Verso </button>
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                            ...
                            <form class="form-horizontal p-t-20">
                                    ...
                                    <div class="col-lg-8 col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-sm-9">
                                                <input type="number" name="number" id="titre" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div><!-- END ROW-->
                                ...
                                <div class="row">
                                   <div class="col-sm-12 col-md-12 col-lg-12 col-xlg-12">
                                    ...
                                    <input type="text" id="dateVerso" value="<?php echo date('Y-m-d H:i:s');?>"hidden>
                        ...
                        <div class="modal-footer">
                            <button style="background-color: #8b4513" class="btn text-white waves-effect text-left" onclick="ajouterVersoArticle($('#titre').val(),$('#langue').val(),$('#corp_article').val(),$('#dateVerso').val())" data-dismiss="modal"><i class="fa fa-check"></i>Creer article
                            </button>

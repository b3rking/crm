    ...
    <div class="col-md-3 col-lg-3 col-xlg-3">
        <div class="card">
            ...
            <div class="box bg-success text-center">
                <h7 class="font-light text-white"><button type="button" class="btn btn-sm btn-rounded btn-success" onclick="getFacturePayerDunClient($('#idclient').val())">Factures payees</button></h7>
            </div>
        </div>
    </div>
    <div class="col-md-3 col-lg-3 col-xlg-3">
	    <div class="card">
	        <div class="box bg-danger text-center">
	            <h7 class="font-light text-white"><button type="button" class="btn btn-sm btn-rounded btn-danger" onclick="getFactureImpayerDunClient($('#idclient').val())">Factures impayees</button></h7>
	        </div>
	    </div>
    </div>
</div>

            ...
            <div class="col-md-6 col-lg-3 col-xlg-3">
                <div class="card">
                    <div class="box bg-info text-center">
                      ...
                      <button type="button" class="btn btn-sm btn-rounded btn-info" class="font-light text-white" onclick="form_nouveau_client()">Nouveau client &nbsp;<?= $nbclient?></button>
             ...
             <div class="col-md-6 col-lg-3 col-xlg-3" hidden="">
                <div class="card">
            ...
            <div class="col-md-6 col-lg-3 col-xlg-3">
                <div class="card">
                    <div class="box bg-megna text-center">
                        <h3 class="font-light text-white">
                            <button type="button" class="btn btn-sm btn-rounded box bg-megna"><a href="<?=WEBROOT;?>client_delinquant" class="font-light text-white">Actif avec dette <?=$client->get_nombre_ClientActif_avec_Dette() //nbClientSoldeSupZero()?></a></button></h3>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3 col-xlg-3">
                <div class="card">
                    <div class="box bg-success text-center">
                        <h3 class="font-light text-white">
                        <button type="button" class="btn btn-sm btn-rounded btn-success"><a href="<?=WEBROOT;?>client_sansdette" class="font-light text-white">Actif sans dette </a><?=$client->get_nombre_clientActif_sans_Dette() //nbClientSoldeInfOuEgalZero()?></button></h3>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 col-lg-3 col-xlg-3">
                <div class="card">
                    <div class="box bg-megna text-center">
                        <h3 class="font-light text-white">
                            <button type="button" class="btn btn-sm btn-rounded box bg-megna"><a href="<?=WEBROOT;?>client_actif" class="font-light text-white">Client actif <?=$client->get_nombre_client_Actif() //nbClientActif()?></a></button></h3>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3 col-xlg-3">
                <div class="card">
                    <div class="box bg-info text-center">
                        <h3 class="font-light text-white">
                            <?php $n =$client->get_nombre_client_avec_solde_negatif() //nbClientSoldeNegatif();?>
            ...
            <div class="col-md-6 col-lg-3 col-xlg-3">
                <div class="card">
                    <div class="box bg-danger text-center">
                        <h3 class="font-light text-white">
                            <?php $k =$client->get_nombre_client_parti_avec_dette() //nbClientPartiAvecDette();?>
            ...
            <div class="col-md-6 col-lg-3 col-xlg-3">
                <div class="card">
                    <div class="box bg-success text-center">
                        <h3 class="font-light text-white">
                            <?php $l =$client->get_nombre_client_parti_sans_dette() //nbClientPartiSansDette();?>
            ...
            <div class="col-md-6 col-lg-3 col-xlg-3">
                <div class="card">
                    <div class="box bg-primary text-center">
                        <h3 class="font-light text-white">
                        <button type="button" class="btn btn-sm btn-rounded btn-primary"><a href="<?=WEBROOT;?>chiffreAffaire" class="font-light text-white">Chiffre d'affaire </a></button></h3>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3 col-xlg-3">
                <div class="card">
                    <div class="box bg-primary text-center">
                        <h3 class="font-light text-white">
                        <button type="button" class="btn btn-sm btn-rounded btn-primary"><a href="<?=WEBROOT;?>factureAnnuelle" class="font-light text-white">Facture annuelle </a></button></h3>
                    </div>
                </div>
            </div>
<!--
            <div class="col-md-6 col-lg-3 col-xlg-3">
                <div class="card">
                    <div class="box bg-primary text-center">
                        <h3 class="font-light text-white">
                        <button type="button" class="btn btn-sm btn-rounded btn-primary"><a href="<=WEBROOT;?>client_speciaux" class="font-light text-white">Client 1000 a 3000 </a></button></h3>
                    </div>
                </div>
            </div>
-->
            ...
            <div class="col-md-6 col-lg-3 col-xlg-3">
                <div class="card">
                    <div class="box bg-info text-center">
                        ...
                        $invoices_amount = 0;
                        foreach ($contract->getfacture_total_dun_mois(date('Y-m-01')) as $value) 
                        {
                            $thisRate = $value->exchange_rate >= 500 ? $value->exchange_rate:$taux;
                            $invoices_amount += (strtolower($value->monnaie) == 'bif' ? $value->montant : $value->montant*$thisRate);
...
//                        echo round($montant_facture_USD).'_'.$tbMonnaie[0].' '.round($montant_facture_monnaie_locale).'_'.$tbMonnaie[1];
                        echo number_format($invoices_amount).' BIF';
                        ?>
                        </h3>
            ...
            <div class="col-md-6 col-lg-3 col-xlg-3">
                <div class="card">
                    <div class="box bg-success text-center">
                        ...
                        $paid_amount = 0;
                        foreach ($contract->getmontant_facture_payee_dun_mois(date('Y-m-01')) as $value) 
                        {
...
//                        echo $montant_facture_payee_USD.'_'.$tbMonnaie[0].' '.$montant_facture_payee_monnaie_locale.'_'.$tbMonnaie[1];
                            echo number_format($paid_amount).' BIF';

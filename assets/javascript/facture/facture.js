...
function creefacture(datefacture,monnaie,mois,annee,tva,customer) 
{
    ...
    else
    {
        ...
        {
            y++;
            var serviceId = $('#service'+i).val().split(/-/)[0];
            var serviceName = $('#service'+i).val().split(/-/)[1];
            var bandeP = ($('#bandeP'+i).val() == '' ? 'null' : $('#bandeP'+i).val());
            var montant = $('#montantt'+i).val().replace(",",".");
            var quantite = $('#quantite'+i).val();
            var reduction = $('#rediction'+i).val();
            var description = ($('#description'+i).val() == '' ? 'null' : $('#description'+i).val());
            ...
            facture_services += serviceId+'_'+serviceName+'_'+bandeP+'_'+montant+'_'+quantite+
            '_'+startDate+'_'+encodeURIComponent(description)+'_'+billing_cycle+'_'+reduction+'=';
        ...
        else
        {
            ...
            //{
                ...
                xhttp.open("GET","ajax/facture/creefacture.php?datefacture="+datefacture+"&monnaie="+monnaie+"&exchange_currency="+exchange_currency+"&mois="+mois+"&annee="+annee+"&tva="+tva+"&client_parent="+client_parent+"&billing_number="+billing_number+"&facture_services="+facture_services+"&i="+i+"&nombreService="+nombreService+"&taux="+taux+"&show_rate="+show_rate+"&enable_discount="+enable_discount+"&fixe_rate="+fixe_rate+"&WEBROOT="+WEBROOT+"&iduser="+iduser+"&next_billing_date="+next_billing_date+"&idcontract="+idcontract+"&test_billing_cycle="+test_billing_cycle,true);
                xhttp.send();
            //}
        }
    }
...
function creerProformat(datefacture,monnaie,mois,annee,tva)
{
    ...
    else
    {
        ...
        for (var i = 0; i < nombreService; i++) 
        {
            ...
            var serviceName = $('#service'+i).val().split(/-/)[1];
            var bandeP = ($('#bandeP'+i).val() == '' ? 'null' : $('#bandeP'+i).val());
            var montant = $('#montant'+i).val().replace(",",".");
            var quantite = $('#quantite'+i).val();
            var description = ($('#description'+i).val() == '' ? 'null' : $('#description'+i).val());
            var billing_cycle = $('#billing_cycle'+i).val();
            if (enable_discount == 1 && billing_cycle == 1) 
            {
                if (quantite >= 3 && quantite <= 5)
                    reduction = 5;
                else if (quantite >= 6 && quantite <= 11) 
                    reduction = 10;
                else if (quantite >= 12) 
                    reduction = 15;
            }
...
//                endDate = $('#endDate'+i).val();
            ...
            facture_services += serviceId+'_'+serviceName+'_'+bandeP+'_'+montant+'_'+quantite+
            '_'+startDate+'_'+endDate+'_'+encodeURIComponent(description)+'_'+billing_cycle+'_'+reduction+'=';
        ...
        else
        {
            ...
            xhttp.open("GET","ajax/facture/creerProformat.php?datefacture="+datefacture+"&facture_services="+facture_services+"&reduction="+reduction+"&monnaie="+monnaie+"&mois="+mois+"&annee="+annee+"&tva="+tva+"&i="+i+"&nombreService="+nombreService+"&taux="+taux+"&exchange_currency="+exchange_currency+"&fixe_rate="+fixe_rate+"&show_rate="+show_rate+"&old_client="+old_client+"&nomclient="+encodeURIComponent(nomclient)+"&phone="+phone+"&mailclient="+mailclient+"&adresse="+encodeURIComponent(adresse)+"&localisation="+localisation+"&enable_discount="+enable_discount+"&iduser="+iduser,true);
            xhttp.send();
        }
    }
}
function updateProformat(type_client,facture_id,datefacture,monnaie,mois,annee,tva,i,id_dernierService) 
{
    ...
    else
    {
        ...
        {
            y = j+1;
            var service = $('#service'+facture_id+y).val().split(/-/);
            var serviceId = service[0];
            var serviceName = service[1];
            var idFs = $('#idFs'+facture_id+y).val();
            var montant = $('#montant'+facture_id+y).val().replace(",",".");
            var quantite = parseInt($('#quantite'+facture_id+y).val());
            //var reduction = $('#reduction'+y).val();
            //var sous_client = $('#sous_client'+y).val();
            var bandeP = ($('#bandeP'+facture_id+y).val() == '' ? 'null' : $('#bandeP'+facture_id+y).val());
            var description = ($('#description'+facture_id+y).val().trim() == '' ? 'null' : $('#description'+facture_id+y).val().trim().replace("&","et"));
            ...
            facture_services += serviceId+'_'+idFs+'_'+montant+'_'+quantite+
            '_'+bandeP+'_'+encodeURIComponent(description)+'_'+billing_cycle+'_'+startDate+'_'+endDate+'_'+serviceName+'=';
            //alert(facture_services);
        ...
        else
        {
            ...
            xhttp.open("GET","ajax/facture/updateProformat.php?facture_id="+facture_id+"&facture_services="+facture_services+"&idclient="+idclient+"&datefacture="+datefacture+"&monnaie="+monnaie+"&fixe_rate="+fixe_rate+"&exchange_currency="+exchange_currency+"&mois="+mois+"&annee="+annee+"&tva="+tva+"&i="+j+"&nombreService="+nombreService+"&afficheTaux="+show_rate+"&enable_discount="+enable_discount+"&reduction="+reduction+"&taux="+taux+"&iduser="+iduser+"&nomclient="+encodeURIComponent(nomclient)+"&telephone="+telephone+"&mail="+mail+"&localisation="+localisation+"&adresse="+encodeURIComponent(adresse),true);
            xhttp.send();
        }
    }
}
function deleteProformat(facture_id)
{
    ...
    xhttp.open("GET","ajax/facture/deleteProformat.php?facture_id="+facture_id+"&iduser="+iduser,true);
    xhttp.send();
}
...
function setBillingCycleContent(billing_cycle,i)
{
    if (billing_cycle == '0') 
    {
        document.getElementById('billingCycleContent'+i).innerHTML = '<div class="row">'+
            '<div class="col-lg-4 col-md-4">'+
                '<label class="control-label">Date debut</label>'+
                '<div class="form-group col-sm-9">'+
                    '<input type="date" class="form-control form-control-sm" name="startDate" id="startDate'+i+'">'+
                '</div>'+
            '</div>'+
        '</div>';
        /*var xhttp;
    ...
    {
        var divbillingCycle = document.getElementById('billingCycleContent'+i);
...
function getFacturePayerDunClient(idclient)
{
    ...
    xhttp.open("GET","ajax/facture/getFacturePayerDunClient.php?idclient="+idclient,true);
    xhttp.send();
}
function  get_facturePayer_dun_mois(mois_debut,annee)
{
    ...
    xhttp.open("GET","ajax/facture/get_facture_payee.php?mois_debut="+mois_debut+"&annee="+annee+"&webroot="+webroot,true);
    xhttp.send();
}
function getFactureImpayerDunClient(idclient)
{
    ...
    xhttp.open("GET","ajax/facture/getFactureImpayerDunClient.php?idclient="+idclient,true);
    xhttp.send();
}
...
function getFacture_impayee(mois_debut,annee) 
{
    ...
    xhttp.open("GET","ajax/facture/Facture_impayee.php?mois_debut="+mois_debut+"&annee="+annee+"&webroot="+webroot,true);
    xhttp.send();
}
function getFactures_Dun_mois(mois_debut,annee_debut) 
{
    ...
    xhttp.open("GET","ajax/facture/get_factures.php?mois_debut="+mois_debut+"&annee_debut="+annee_debut+"&webroot="+webroot,true);
    xhttp.send();
}
function genererListeFactureNoPayer(mois,annee,idUser)
{
    ...
    xhttp.open("GET","ajax/facture/genererListeFactureNoPayer.php?mois="+mois+"&annee="+annee+"&idUser="+idUser,true);
    xhttp.send();
}
function genererClientAcouper(idUser)
{
    ...
    xhttp.open("GET","ajax/facture/genererClientAcouper.php?idUser="+idUser,true);
    xhttp.send();
}
...
$("#motif").on('change', function(){
    ...
    if (type_client == 'paying') 
    {
        ...
        xhttp.onreadystatechange = function()
        {
            ...
            {
                //var rep = String(this.responseText).trim();
                document.getElementById("factureContener").innerHTML = this.responseText;
                ///msg.style.color = 'green';
                //msg.innerHTML = this.responseText; 
            }
        };
        xhttp.open("GET","ajax/facture/getFacturesDunClient.php?idclient="+idclient+"&i="+i,true);
        xhttp.send();
    }
    /*if($('#motif').val())
    {
...
function couperUnClient(action,idclient,motif,observation,idUser,type_client,date_creation)
{
    ...
    else
    {
        ...
        xhttp.open("GET","ajax/facture/couperUnClient.php?idclient="+idclient+"&observation="+observation+"&action="+action+"&idUser="+idUser+"&motif="+motif+"&type_client="+type_client+"&date_creation="+date_creation+"&facture_id="+facture_id,true);
        xhttp.send();
    }
}
function activerClient(idclient,idUser)
{
    ...
    else
    {
        ...
        xhttp.open("GET","ajax/facture/activerClient.php?idclient="+idclient+"&idUser="+idUser,true);
        xhttp.send();
    }
}
function ajouterClientAuListeDeCoupure(idclient,action,observation,idUser)
{
    ...
    else
    {
        ...
        xhttp.open("GET","ajax/facture/couperUnClient.php?idclient="+idclient+"&observation="+observation+"&action="+action+"&cutoff_id="+cutoff_id+"&idUser="+idUser,true);
        xhttp.send();
    }
}
...
function creerCoupure(date_coupure)
{
    ...
    xhttp.open("GET","ajax/facture/saveCoupure.php?date_coupure="+date_coupure,true);
    xhttp.send();
}
function update_cutoff_list(date_coupure,cutoff_id,i)
{
    ...
    xhttp.open("GET","ajax/facture/update_cutoff_list.php?date_coupure="+date_coupure+"&confirmed="+confirmed+"&cutoff_id="+cutoff_id,true);
    xhttp.send();
}
function delete_cutoff_list(cutoff_id)
{
    ...
    xhttp.open("GET","ajax/facture/delete_cutoff_list.php?cutoff_id="+cutoff_id,true);
    xhttp.send();
}
function saveDerogation()
{
    ...
    else
    {
        $('input:checkbox:checked').each(function()
        {
            ...
            xhttp.open("GET","ajax/facture/saveDerogation.php?mois="+mois+"&annee="+annee+"&monnaie="+monnaie+"&montant="+montant+"&idclient="+idclient+"&action="+action+"&motif="+motif,true);
            xhttp.send();
        });
    }
}
function checkActionCoupure(action,idclient,i)
{
    if (action != '') 
    {
        ...
        xhttp.onreadystatechange = function()
        {
            ...
            {
                //var rep = String(this.responseText).trim();
                document.getElementById("motif_contener"+i).innerHTML = this.responseText; 
            }
        };
        xhttp.open("GET","ajax/facture/motif_coupure.php?action="+action+"&i="+i+"&idclient="+idclient,true);
        xhttp.send();
    }
}
function getFacturesDunClient(motif,idclient,i)
{
    if (motif == 'dette') 
    {
        ...
        xhttp.onreadystatechange = function()
        {
            ...
            {
                //var rep = String(this.responseText).trim();
                document.getElementById("factureContener"+i).innerHTML = this.responseText;
                ///msg.style.color = 'green';
                //msg.innerHTML = this.responseText; 
            }
        };
...
function updateCoupure(action,observation,idclient,i,coupure_id,montant,monnaie)
{
    ...
    xhttp.open("GET","ajax/facture/updateCoupure.php?idclient="+idclient+"&observation="+observation+"&action="+action+"&coupure_id="+coupure_id+"&montant="+montant+"&monnaie="+monnaie,true);
    xhttp.send();
}
function deleteCoupureAction(coupure_id,idclient)
{
    ...
    xhttp.open("GET","ajax/facture/deleteCoupureAction.php?coupure_id="+coupure_id+"&idclient="+idclient,true);
    xhttp.send();
}
function updateFacture(idclient,facture_id,datefacture,monnaie,mois,annee,tva,billing_number,i,id_dernierService,idcontract,next_billing_date,billing_date) 
{
    ...
    if (datefacture == '' || annee == '') 
    {
        ...
        msg.style.color = 'red';
        msg.innerHTML = 'Veuillez renseigner tous les champs en etoile et la quantite doit etre > 0';
    }
    ...
    else
    {
        ...
        for (var j = 0; j < nombreService; j++) 
        {
            ...
            //var sous_client = $('#sous_client'+y).val();
            var bandeP = ($('#bandeP'+facture_id+y).val() == '' ? 'null' : $('#bandeP'+facture_id+y).val());
            var description = ($('#description'+facture_id+y).val().trim() == '' ? 'null' : $('#description'+facture_id+y).val().trim());
            var billing_cycle = $('#Billing_cycle'+facture_id+y).val();
            if (montant == '' || quantite == '') 
            {
                swal({   
            ...
            facture_services += serviceId+'_'+idFs+'_'+montant+'_'+quantite+
            '_'+bandeP+'_'+encodeURIComponent(description)+'_'+billing_cycle+'_'+startDate+'_'+serviceName+'_'+reduction+'=';
            //alert(facture_services);
            //alert('idclient: '+idclient+' facture_id: '+facture_id+' idFs: '+idFs+' datefacture: '+datefacture+' monnaie: '+monnaie+' mois: '+mois+' annee: '+annee+' tva: '+tva+' service: '+service+' montant: '+montant+' monnaiservice: '+monnaieService+' quantite: '+quantite+' rediction: '+rediction+' bandeP: '+bandeP+' description: '+description+' billing_cycle: '+billing_cycle+' startDate: '+startDate+' endDate: '+endDate);
        ...
        if (facture_services != '') 
        {
            ...
            xhttp.open("GET","ajax/facture/updateFacture.php?facture_id="+facture_id+"&facture_services="+facture_services+"&idclient="+idclient+"&datefacture="+datefacture+"&monnaie="+monnaie+"&fixe_rate="+fixe_rate+"&exchange_currency="+exchange_currency+"&mois="+mois+"&annee="+annee+"&tva="+tva+"&billing_number="+billing_number+"&i="+j+"&nombreService="+nombreService+"&afficheTaux="+show_rate+"&enable_discount="+enable_discount+"&taux="+taux+"&next_billing_date="+next_billing_date+"&billing_date="+billing_date+"&idcontract="+idcontract+"&iduser="+iduser+"&test_billing_cycle="+test_billing_cycle,true);
            xhttp.send();
        }
    }
}
function creerfactureEnMasse(mode,date_creation,mois,annee,taux)
{
    ...
    if (mode == '' || date_creation == '' || mois == '' || annee == '' || taux == '') 
        swal({   
            title: "",   
        ...
        document.getElementById("massInvoiceForm").submit();
}
function massInvoiceDelete(month,year,mode)
{
    ...
    xhttp.open("GET","ajax/facture/massDeleteInvoice.php?month="+month+"&year="+year+"&mode="+mode,true);
    xhttp.send();
}
function deleteFacture(id_facture,mois_debut,annee_debut,idclient,idcontract,billing_date)
{
    ...
    xhttp.open("GET","ajax/facture/deleteFacture.php?id_facture="+id_facture+"&mois_debut="+mois_debut+"&annee_debut="+annee_debut+"&WEBROOT="+WEBROOT+"&iduser="+iduser+"&idclient="+idclient+"&idcontract="+idcontract+"&billing_date="+billing_date,true);
    xhttp.send();
}
...
function addServiceToProforma()
{
    ...
    if (nbserviceProforma < 5) 
    {
        ...
        xhttp.open("GET","ajax/facture/addServiceToProforma.php?nbserviceProforma="+nbserviceProforma,true);
        xhttp.send();
    }
}
function creerBallanceInitiale(idclient,date_creation,montant,monnaie,description)
{
    ...
    else
    {
        ...
        xhttp.open("GET","ajax/facture/creerBallanceInitiale.php?idclient="+idclient+"&date_creation="+date_creation+"&montant="+montant+"&monnaie="+monnaie+"&description="+description+"&iduser="+iduser,true);
        xhttp.send();
    }
}
function updateBallanceInitiale(idbalance,idclient,montant,monnaie,datebalance,description)
{
    ...
    else  
    {
        ...
        xhttp.open("GET","ajax/facture/updateBallanceInitiale.php?id="+idbalance+"&idclient="+idclient+"&montant="+montant+"&monnaie="+monnaie+"&datebalance="+datebalance+"&description="+description+"&iduser="+iduser,true);
        xhttp.send();
    }
}
function deleteBallance(id,idclient)
{
    ...
    xhttp.open("GET","ajax/facture/deleteBallanceInitiale.php?id="+id+"&idclient="+idclient+"&iduser="+iduser,true);
    xhttp.send();
}
function creerPause(idclient,dateDebut,dateFin,raison,type_suspension,date_creation,idUser)
{
    ...
    else
    {
        ...
        xhttp.open("GET","ajax/facture/creerPause.php?idclient="+idclient[1]+"&dateDebut="+dateDebut+"&dateFin="+dateFin+"&raison="+raison+"&type_suspension="+type_suspension+"&date_creation="+date_creation+"&idUser="+idUser,true);
        xhttp.send();
    }
}
function updatePause(idPause,idclient,dateDebut,dateFin,raison,type_pause,idUser)
{
    ...
    xhttp.open("GET","ajax/facture/updatePause.php?idPause="+idPause+"&dateDebut="+dateDebut+"&dateFin="+dateFin+"&raison="+raison+"&type_pause="+type_pause+"&idUser="+idUser,true);
    xhttp.send();
}
function getCauseSuppresionPause(element,i)
{
    ...
    else if (element.id == 'pause_terminer'+i) 
    {
        if (document.getElementById(element.id).checked == true) 
        {
            document.getElementById('deletePause_parErreur'+i).checked = false;
...
function deletePause(idPause,idclient,dateDebut,idUser,i)
{
    ...
    else
    {
        ...
        xhttp.open("GET","ajax/facture/deletePause.php?idPause="+idPause+"&idclient="+idclient+"&idUser="+idUser+"&dateOuverture="+dateOuverture+"&checkDelete="+checkDelete+"&dateDebut="+dateDebut,true);
        xhttp.send();
    }
}
function sendFacture(mois_fact,annee_fact)
{
    //alert(mois_fact+'  '+annee_fact);
    var xhttp;
    xhttp = new XMLHttpRequest();
    xhttp.onreadystatechange = function()
    {
        if (this.readyState == 4) 
        {
            var msg = document.getElementById('msg_sendfact');
            /*msg.style.color = 'green';
            msg.innerHTML = this.responseText;*/
            document.getElementById('rep').innerHTML = this.responseText;
            var rep = String(this.responseText).trim();
    ...
    xhttp.open("GET","ajax/Sender/sendFacture.php?mois_fact="+mois_fact+"&annee_fact="+annee_fact,true);
    xhttp.send();
}
function filtreFacture(billing_number,nom_client,date1,date2,mode,mois,annee) 
{
    ...
    else
    {
        ...
        xhttp.open("GET","ajax/facture/filtreFacture.php?condition="+condition+"&WEBROOT="+WEBROOT+"&m="+m+"&s="+s,true);
        xhttp.send();
    }
}
...
function filtreProformat(num_fact,nom_client,date1,date2) 
{
    ...
    else
    {
        ...
        xhttp.open("GET","ajax/facture/filtreProformat.php?condition="+condition+"&WEBROOT="+WEBROOT,true);
        xhttp.send();
    }
}
...
function calculerMontantFacture(status,mois,annee)
{
    ...
    xhttp.open("GET","ajax/facture/calculerMontantFacture.php?status="+status+"&mois="+mois+"&annee="+annee,true);
    xhttp.send();
}
function filtreRaportFacture(status,mois,annee)
{
    ...
    {
        var condition = " AND fs.mois_debut='"+mois+"' AND fs.annee="+annee;
        $('#cond').val(condition);
        $('#type').val(status);
        var xhttp;
        xhttp = new XMLHttpRequest();
        ...
        xhttp.open("GET","ajax/facture/filtreRaportFacture.php?condition="+condition+"&status="+status+"&webroot="+webroot,true);
        xhttp.send();
    }
}
...
function ajoutServiceToFacture()
{
    ...
    xhttp.open("GET","ajax/facture/includeServiceOnCreerfacture.php?n="+m+"&action="+action,true);
    xhttp.send();
}
...
function ajoutServiceToUpdateFacture(facture_id,i)
{
    ...
    xhttp.open("GET","ajax/facture/includeServiceOnUpdatefacture.php?n="+j+"&facture_id="+facture_id,true);
    xhttp.send();
}
var k = 0;
function ajoutServiceToProformat()
{
    ...
    xhttp.open("GET","ajax/autocomplete/includeServiceOnCreerfacture_proformat.php?n="+k,true);
    xhttp.send();
}
...
function ajoutServiceToUpdateFactureProformat(facture_id,i)
{
    ...
    xhttp.open("GET","ajax/facture/includeServiceOnUpdateFactureProformat.php?n="+j+"&facture_id="+facture_id,true);
    xhttp.send();
}

...
class myPDF extends FPDF
{
	...
	function header()
	{
		...
		$this->Ln();
		$this->Cell(120,5,'Le '.date('d-m-Y'),0,1,'R');

		$this->Cell(90,5,'SECTEUR TOTAL ',0,1,'C');
			$this->Ln(8);
	...
	{	$this->SetFont('Arial','B',11);
		...
		$this->Cell(8,5,'No',1,0);
		$this->Cell(35,5,'NOM SECTEUR',1,0);
		$this->Cell(30,5,'ADRESSE',1,1);
		//$this->Cell(50,5,'Adresse',1,0);
		//$this->Cell(35,5,'Mail',1,0);
		//$this->Cell(35,5,'Personne de contact',1,1);
		$this->SetFont('Arial','',9);
		
		//$i = 0;
		foreach ($equipement->affichageSecteur() as $value) 
		{
			//$i++;
		        $this->Row([$value->ID_secteur,$value->nom_secteur,$value->adresse_secteur]);
    	}
...
$pdf->SetWidths(array(8,35,30));
$pdf->viewTable($equipement);
$pdf->Output();
?>

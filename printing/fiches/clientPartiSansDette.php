...
class myPDF extends FPDF
{
	...
	function header()
	{
		...
		$this->Ln(15);
		$this->Cell(160,5,'Client parti sans dette ',0,1,'C',1);
	}
	function footer()
	{
	    /*$this->Ln();
	...
	{	$this->SetFont('Arial','B',11);
		...
		$this->Cell(128,5,'Client',1,1,'C',1);
		$this->SetFont('Arial','',9);
		
		$i = 0;
		$total_dette = 0;
		foreach ($client->getClientPartiSansDette() as $value) 
		{
            ...
            {
            	$i++;
                $this->Row([$i,$value->ID_client,$value->Nom_client]);
            }*/
            $i++;

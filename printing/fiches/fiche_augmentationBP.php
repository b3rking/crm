...
class myPDF extends FPDF
{
	...
	function headerTable()
	{
		...
		$this->Cell(60,5,'FICHE D\' AUGMENTATION DE BP',0,1,'C');
		$this->Line(66,60,144,60);
		$this->Ln(10);
		$this->SetFont('Arial','',12);
		...
		$this->Cell(95,5,iconv('UTF-8', 'windows-1252', $this->getClient()['adresse']), 0,0);
		//$this->Cell(95,5,': '.$this->getClient()['adresse'], 0,1,'L');
		$this->Ln(3);
		...
		$this->Cell(80,5,':......................................................................', 0,1);
		/*$this->Cell(60,5,iconv('UTF-8', 'windows-1252', '$this->getClient()['adresse']'), 0,0);
		if ($this->getGenerer()) 
		{
		...
		$this->Ln(10);
		$this->Cell(60,5,iconv('UTF-8', 'windows-1252', 'Bande Passante à augmenter'), 0,0);
		$this->Cell(80,5,': '.iconv('UTF-8', 'windows-1252', $this->getBandeP()).' Mbps', 0,1);
    	$this->Ln(3);
    	$this->Cell(60,5,iconv('UTF-8', 'windows-1252', 'Augmentation à partir du'), 0,0);

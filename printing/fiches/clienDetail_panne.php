...
class myPDF extends FPDF
{
	...
	function header()
	{
		...
		$this->Cell(160,5,'Detail panne client  ',0,1,'C');
			$this->Ln(8);
	...
	{	$this->SetFont('Arial','B',11);
		...
		$this->Cell(35,5,'Panne',1,0,'c',1);
		$this->Cell(35,5,'Description',1,1,'c',1);
		$this->SetFont('Arial','',9);
		
		$i = 0;
		foreach ($client->detail_panne_client() as $value) 
		{
			$i++;
		        $this->Row([$i,$value->Nom_client,$value->telephone,$value->adresse,$value->problem,$value->description]);
    	}

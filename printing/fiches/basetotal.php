...
class myPDF extends FPDF
{
	...
	function header()
	{
		...
		$this->Cell(180,5,'BASE TOTALE',0,1,'C');
			$this->Ln(8);
	...
	{	$this->SetFont('Arial','B',11);
		...
		$this->Cell(35,5,'NOM',1,0);
		$this->Cell(30,5,'IP',1,0);
		$this->Cell(50,5,'MAC',1,0);
		$this->Cell(35,5,'FREQUENCE',1,0);
		$this->Cell(35,5,'ANTENNE LIMITE',1,1);
		$this->SetFont('Arial','',9);
		
		$i = 0;
		
		foreach ($equipement->affichagePoint_acces() as $value) 
		{
			$i++;
		        $this->Row([$i,$value->nom,$value->ip,$value->mac,$value->frequence,$value->antenne_limite]);
    	}

...
class myPDF extends FPDF
{
	...
	function header()
	{
		...
		$this->Cell(160,5,'Client en derogation ',0,1,'C');
			$this->Ln(8);
	...
	{	
		...
		$this->Cell(115,5,'Nom client',1,0,'C',1);
		$this->Cell(35,5,'Solde',1,1,'C',1);
		$this->SetFont('Arial','',9);
		$i=0;
		$total_dette_USD = 0;
    	...
    	$this->SetFont('Arial','B',9);
    	$this->Cell(145,8,'Total '.$tbMonnaie[0],'TLB',0);
    	$this->Cell(35,8,round($total_dette_USD).' '.$tbMonnaie[0],'TRB',1);

    	$this->SetFont('Arial','B',9);
    	$this->Cell(145,8,'Total '.$tbMonnaie[1],'TLB',0);
    	$this->Cell(35,8,round($total_dette_monnaie_locale).' '.$tbMonnaie[1],'TRB',0);
	}
}
...
$pdf->SetWidths(array(10,20,115,35));

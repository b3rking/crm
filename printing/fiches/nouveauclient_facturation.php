...
class myPDF extends FPDF
{
	...
	function header()
	{
		...
		$this->Cell(190,5,'Nouveau client du mois ',0,1,'C');
			$this->Ln(8);
	...
	{	
		...
		$this->Cell(24,8,'Date creation',1,0,'',1);
		$this->Cell(60,8,'Client',1,0,'',1);
		$this->Cell(50,8,'Adresse',1,0,'',1);
		$this->Cell(30,8,'Etat',1,0,'',1);
		$this->Cell(20,8,'Billing',1,1,'',1);
		$this->SetFont('Arial','',9);
		//$i=0;
		foreach ($client->getallClient($this->getMois(),$this->getAnnee()) as $value) 
		{ // $i++;
			
		        $this->Row([$value->date_creation,$value->Nom_client,$value->adresse,$value->etat,$value->billing_number]);
    	}
...
$pdf->SetWidths(array(24,60,50,30,20));

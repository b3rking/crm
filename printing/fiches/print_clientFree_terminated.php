...
class myPDF extends FPDF
{
	...
	function header()
	{
		...
		$this->Cell(160,5,'Client gratuit et terminated ',0,1,'C');
			$this->Ln(8);
	...
	function headerTable()
	{
		...
		$this->Cell(100,5,'Nom client',1,0,'C',1);
		$this->Cell(20,5,'Telephone',1,0,'C',1);
		//$this->Cell(20,5,'Service',1,0,'C',1);
		$this->Cell(20,5,'Etat',1,0,'C',1);
		$this->Cell(20,5,'Type',1,1,'C',1);
	}
	...
	{	
		...
		foreach ($client->listeClient_gratuit() as $value) 
		{
			$i++;
			
    		$this->Row([$i,$value->ID_client,$value->Nom_client,$value->telephone,$value->etat,$value->type_client]);
...
$pdf->SetWidths(array(10,20,100,20,20,20));

...
class myPDF extends FPDF
{
	...
	function header()
	{
		...
		$this->Cell(100,5,'Nom client',1,0,'C');
		$this->Cell(30,5,'Mensualite',1,0,'C');
		$this->Cell(25,5,'Monnaie',1,1,'C');
	}
	function viewTable($contract,$result)
	{
		...
		foreach ($result as $value) 
		{
			...
			$this->Row([$i,$value->billing_number,$value->Nom_client,number_format($montant_total),$value->monnaie]);	
		}
		$this->SetFont('Arial','B',9);
...
$pdf->AddPage();
//$pdf->headerTable();
$pdf->SetWidths(array(10,10,100,30,25));

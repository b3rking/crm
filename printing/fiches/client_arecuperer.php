...
class myPDF extends FPDF
{
	...
	function header()
	{
		...
		$this->Cell(160,5,'Client a recuperer ',0,1,'C');
			$this->Ln(8);
	...
	{	$this->SetFont('Arial','B',11);
		...
		$i = 0;
		foreach ($client->getClientA_recuperer() as $value) 
		{
			$i++;
		        $this->Row([$i,$value->Nom_client,$value->telephone,$value->adresse,$value->mail,$value->personneDeContact]);
    	}

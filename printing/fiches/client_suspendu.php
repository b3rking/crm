...
class myPDF extends FPDF
{
	...
	function header()
	{
		...
		$this->Cell(160,5,'Client en suspenssion ',0,1,'C');
			$this->Ln(8);
	...
	{	
		...
		$this->Cell(15,5,'ID_client',1,0); 
		$this->Cell(52,5,'Nom client',1,0);
		$this->Cell(30,5,'Date creation',1,0);
		$this->Cell(35,5,'Type suspenssion',1,0);
		$this->Cell(20,5,'Raison',1,0);
		$this->Cell(18,5,'Mois',1,0);
		$this->Cell(28,5,'Date fin',1,1);
		$this->SetFont('Arial','',9);


    	foreach ($client->getAll_clientEnsuspenssion() as $value) 
    	{
    		$this->Row([$value->ID_client,$value->Nom_client,$value->date_creer,$value->type_suspension,$value->raison,$tb_mois[$value->mois],$value->date_fin]);
...
$pdf->SetWidths(array(15,52,30,35,20,18,28));

...
class myPDF extends FPDF
{
	...
	function header()
	{
		...
		$this->Cell(160,5,'Client en pause ',0,1,'C');
			$this->Ln(8);
	...
	{	$this->SetFont('Arial','B',11);
		...
		$this->Cell(155,5,'CLIENT',1,1);
		//$this->Cell(25,5,'Debut pause',1,0);
		//$this->Cell(25,5,'Fin pause',1,0);
		//$this->Cell(35,5,'Description',1,0);
		//$this->Cell(35,5,'Type ',1,1);
		$this->SetFont('Arial','',9);
		$i = 0;
		$total_dette = 0;
		foreach ($contract->getClientEnPauses2() as $value) 
		{
			$i++;
